...
export function instantiateTemplate(iriDeclaration: string, literalDeclarations: string, variableDeclaration: string, conjecture: string) {
	return `
; ------------ Sort and Predicate -------------------
...
export function instantiateQueryContainmentConjecture(subQueryStatements: string, superQueryStatements: string, superQueryVariablesDeclaration: string, projectionVariableAssoc: string) {
	return `(assert
	(and
